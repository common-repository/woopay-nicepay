...
if ( ! class_exists( 'WooPayNicePayEmail' ) ) {
	class WooPayNicePayEmail extends WC_Email {
		
		public function __construct() {
			$this->id               = 'customer_awaiting_order';
			$this->title            = __( 'Awaiting Payment (NicePay)', 'woopay-core' );
			...
			$this->template_html    = 'emails/woopay-nicepay-awaiting-payment.php';
			$this->template_plain   = 'emails/plain/woopay-nicepay-awaiting-payment.php';
